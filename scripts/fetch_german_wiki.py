"""
Fetch German/Austrian/Swiss person names from zh.wikipedia (BFS).
Run from project root:
  python3 scripts/fetch_german_wiki.py
"""
...
OUTPUT = "data/german_wikidata.csv"
LANG   = "de"
MAX_DEPTH = 4
...
ROOTS = [
    "各职业德国男性", "各职业德国女性",
    "德国政治人物", "德国政治家",
    "纳粹德国人物", "东德政治人物", "西德政治人物",
    "德国运动员", "德国足球运动员", "德国男子足球运动员", "德国女子足球运动员",
    "德国音乐家", "德国古典音乐作曲家", "德国歌手",
    "德国作家", "德国诗人", "德国哲学家",
    "德国科学家", "德国数学家", "德国物理学家", "德国化学家",
    "德国演员", "德国导演",
    "奥地利人", "各职业奥地利男性", "各职业奥地利女性",
    "奥地利政治人物", "奥地利音乐家", "奥地利作曲家",
    "瑞士人", "瑞士政治人物",
]
...
def is_valid_native(s): return bool(re.search(r'[A-Za-zÄÖÜäöüßÀ-ÿ]', s)) and len(s.strip()) > 1
...
def main():
    ...
    for i in range(0, len(titles), 50):
        ...
        for zh_title, native in links.items():
            ...
            # Strip disambiguation like "Merkel (Politikerin)"
        ...
        time.sleep(0.25)
    print(f"\nTotal: {len(rows)} German↔Chinese pairs")
    with open(OUTPUT, "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f, quoting=csv.QUOTE_ALL)
        writer.writerow(["german", "chinese", "gender"])
