...
export const TERMS: GovTerm[] = [
  ...
  // ── 司法・檢察體系 ──
  { zh: '最高法院', en: 'Supreme Court', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC, note: '民事及刑事案件終審法院；行政案件走最高行政法院' },
  { zh: '最高行政法院', en: 'Supreme Administrative Court', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '高等法院', en: 'High Court', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '地方法院', en: 'District Court', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '智慧財產及商業法院', en: 'Intellectual Property and Commercial Court', abbr: 'IPCC', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '最高檢察署', en: 'Supreme Prosecutors Office', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC, note: '附設於最高法院' },
  { zh: '高等檢察署', en: 'High Prosecutors Office', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '地方檢察署', en: 'District Prosecutors Office', category: '机构', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '院長（法院）', en: 'Court President', category: '职位', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC, note: '各法院首長；英文亦用 Chief Judge' },
  { zh: '庭長', en: 'Chief Judge', category: '职位', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC, note: '各庭首長' },
  { zh: '法官', en: 'Judge', category: '职位', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '檢察總長', en: 'Prosecutor General', category: '职位', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC, note: '最高檢察署首長' },
  { zh: '檢察長', en: 'Chief Prosecutor', category: '职位', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC, note: '各地方/高等檢察署首長' },
  { zh: '檢察官', en: 'Prosecutor', category: '职位', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },
  { zh: '公設辯護人', en: 'Public Defender', category: '职位', side: 'tw', group: '司法・檢察體系', status: '现行', source: TW_SRC },

  // ── 外交體制（臺灣）──
  { zh: '大使', en: 'Ambassador', category: '职位', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '用於正式邦交國（現約12國）；非邦交國用「代表」' },
  { zh: '大使館', en: 'Embassy', category: '机构', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '設於正式邦交國' },
  { zh: '代表', en: 'Representative', category: '职位', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '台灣特有頭銜，用於非邦交國（勿譯 Ambassador）' },
  { zh: '副代表', en: 'Deputy Representative', category: '职位', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC },
  { zh: '駐外代表處', en: 'Overseas Representative Office', category: '机构', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '非邦交國台灣外交機構通稱' },
  { zh: '台北經濟文化辦事處', en: 'Taipei Economic and Cultural Office', abbr: 'TECO', category: '机构', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '台灣駐美各城市辦事處正式名稱' },
  { zh: '台北經濟文化代表處', en: 'Taipei Economic and Cultural Representative Office', abbr: 'TECRO', category: '机构', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '台灣駐美國（華盛頓）代表機構正式名稱' },
  { zh: '美國在台協會', en: 'American Institute in Taiwan', abbr: 'AIT', category: '机构', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '美國駐台非官方機構，具大使館功能' },
  { zh: '日本台灣交流協會', en: 'Japan-Taiwan Exchange Association', category: '机构', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '日本駐台非官方機構；2017年由「交流協會」更名' },
  { zh: '駐台代表', en: 'Representative to Taiwan', category: '职位', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC, note: '非邦交國駐台辦事機構首長頭銜' },
  { zh: '外交部領事事務局', en: 'Bureau of Consular Affairs', category: '机构', side: 'tw', group: '外交體制（臺灣）', status: '现行', source: TW_SRC },

  // ── 軍事機構・職銜 ──
  { zh: '聯合參謀本部', en: 'Joint Staff', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC, note: '2013年改制，原參謀本部' },
  { zh: '陸軍司令部', en: 'Army Command', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '海軍司令部', en: 'Navy Command', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '空軍司令部', en: 'Air Force Command', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '海軍陸戰隊司令部', en: 'Marine Corps Command', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '後備指揮部', en: 'Reserve Command', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '憲兵指揮部', en: 'Military Police Command', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '海巡署', en: 'Coast Guard Administration', abbr: 'CGA', category: '机构', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC, note: '隸屬海洋委員會，掌海域執法與搜救' },
  { zh: '參謀總長', en: 'Chief of the General Staff', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '陸軍司令', en: 'Commander, Army', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '海軍司令', en: 'Commander, Navy', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '空軍司令', en: 'Commander, Air Force', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '上將', en: 'General / Admiral', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC, note: '陸/空軍 General；海軍 Admiral' },
  { zh: '中將', en: 'Lieutenant General / Vice Admiral', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '少將', en: 'Major General / Rear Admiral', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC },
  { zh: '上校', en: 'Colonel / Captain', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC, note: '陸/空軍 Colonel；海軍 Captain' },
  { zh: '中校', en: 'Lieutenant Colonel / Commander', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC, note: '陸/空軍 Lieutenant Colonel；海軍 Commander' },
  { zh: '少校', en: 'Major / Lieutenant Commander', category: '职位', side: 'tw', group: '軍事機構・職銜', status: '现行', source: TW_SRC, note: '陸/空軍 Major；海軍 Lieutenant Commander' },

  // ── 行政院下屬重要機關 ──
  { zh: '移民署', en: 'National Immigration Agency', abbr: 'NIA', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬內政部' },
  { zh: '警政署', en: 'National Police Agency', abbr: 'NPA', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬內政部' },
  { zh: '消防署', en: 'National Fire Agency', abbr: 'NFA', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬內政部' },
  { zh: '調查局', en: 'Investigation Bureau', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬法務部，掌刑事偵查、情報，功能近似美國 FBI' },
  { zh: '廉政署', en: 'Agency Against Corruption', abbr: 'AAC', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬法務部，主管廉政調查' },
  { zh: '矯正署', en: 'Agency of Corrections', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬法務部，管理監所' },
  { zh: '關務署', en: 'Customs Administration', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬財政部' },
  { zh: '國有財產署', en: 'National Property Administration', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬財政部' },
  { zh: '疾病管制署', en: 'Centers for Disease Control', abbr: 'CDC Taiwan', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬衛生福利部；與美國 CDC 同名但各自獨立' },
  { zh: '食品藥物管理署', en: 'Food and Drug Administration', abbr: 'TFDA', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬衛生福利部；台灣 FDA' },
  { zh: '健康保險署', en: 'National Health Insurance Administration', abbr: 'NHIA', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬衛生福利部，管理全民健保' },
  { zh: '智慧財產局', en: 'Intellectual Property Office', abbr: 'TIPO', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬經濟部，掌專利/商標/著作權' },
  { zh: '貿易署', en: 'Bureau of Foreign Trade', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬經濟部' },
  { zh: '民用航空局', en: 'Civil Aeronautics Administration', abbr: 'CAA', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬交通及建設部' },
  { zh: '體育署', en: 'Sports Administration', category: '机构', side: 'tw', group: '行政院下屬重要機關', status: '现行', source: TW_SRC, note: '隸屬教育部' },
];

export const GROUP_ORDER = ['党中央机构', '中共中央领导职务', '国务院组成部门', '国务院直属机构与国家局', '中国人民解放军', '全国人大·政协', '最高法·最高检', '中央国家机关职务', '地方行政区划', '地方政府职务', '外交衔级', '机构通名对照', '中央政府（總統府・五院）', '行政院各部', '行政院委員會・獨立機關', '臺灣政府職銜', '司法・檢察體系', '外交體制（臺灣）', '軍事機構・職銜', '行政院下屬重要機關', '联合国主要机关', '联合国专门机构与系统', '其他国际与区域组织', '更多国际与区域组织', '国际组织主要职务', '各国情报与安全机构', '宗教机构与领袖', '欧盟机构', '美国主要机构', '英国主要机构', '法国主要机构', '德国主要机构', '意大利主要机构', '日本主要机构', '俄罗斯主要机构', '韩国主要机构', '印度主要机构', '印度尼西亚主要机构', '澳大利亚主要机构', '加拿大主要机构', '巴西主要机构', '墨西哥主要机构', '阿根廷主要机构', '沙特阿拉伯主要机构', '土耳其主要机构', '南非主要机构', '新加坡主要机构', '马来西亚主要机构', '泰国主要机构', '越南主要机构', '菲律宾主要机构', '东盟其他国家', '朝鲜主要机构', '以色列主要机构', '伊朗主要机构', '乌克兰主要机构'];
